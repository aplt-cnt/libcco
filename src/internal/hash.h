...
/* Interns a string. If the string is already in the table, returns the existing pointer.
   Otherwise, allocates a copy in the arena and inserts it. Returns NULL on OOM. */
